    ...
    return (
        <>
            <Paper sx={{padding: 3, backgroundColor: "lightgray", marginTop: 1, position: 'relative'}} square>
                ...
                <ToggleButton value={'containerCode'} sx={{position: "absolute", bottom: 10, right: 10}} size={"small"}
            ...
            <CardContent>
                <Box sx={{flexGrow: 1, bgcolor: 'background.paper', display: 'flex'}}>
                    ...
                    <TabPanel value={value} index={0}>
                        ...
                        <ToggleButton value={'componentCode'} sx={{position: "absolute", bottom: 10, right: 10}}
                                      size={"small"}
                        ...
                        <Box sx={{display: 'flex', justifyContent: 'flex-start',}}>
                            ...
                            <Item> <Alert style={{marginLeft: 4}} severity={"info"}>Click
                                on the <Link sx={{cursor: "pointer"}}
                                             onClick={() => setValue(content ? 4 : 3)}>"view"</Link> tab to see the
                                result
                                of the
