            ...
            <Box sx={{display: 'flex', flexDirection: 'row', pt: 2}}>
                ...
                >
                    <ToggleButton size={'small'} value="reactJsx" aria-label="reactJsx">
                        ...
                        <SvgIcon fontSize={"1"} sx={{position: "absolute", right: 4, bottom: 2}}>
                            <path
            ...
            <CardContent>
                <Box sx={{flexGrow: 1, bgcolor: 'background.paper', display: 'flex'}}>
                    ...
                    <TabPanel value={value} index={content ? 3 : 2}>
                        ...
                        <Alert style={{marginTop: 4}} severity={"info"}>Click
                            on the <Link sx={{cursor: "pointer"}}
                                         onClick={() => setValue(content ? 4 : 3)}>"view"</Link> tab to see the result
                            of the
                            following code snippet</Alert>
                        <CopyBlock
                            language={language}
